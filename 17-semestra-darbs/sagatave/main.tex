\documentclass[notitlepage,reprint,nofootinbib]{revtex4-2}
...
%% USEFUL LINKS:
%%
%%   LU LaTeX guides:         https://www.biblioteka.lu.lv/resursi/abonetie-e-resursi/overleaf-commons/
...
% ===========================================
\section{Metodes}\label{sec:methods}
%
...
% -------------------------------------------
\subsection*{Izmantotie resursi (Tools)}
%
...
% ===========================================
\section{Rezultāti un diskusija}\label{sec:results_and_discussion}
%
...
% ===========================================
\section{Secinājumi}\label{sec:conclusion}
%
...
%Atcerieties, ka pielikumos jāievieto visas lielapjoma tabulas un attēli.
